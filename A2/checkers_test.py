    ...
    if player == 'r':
        ...
        if x <= 5 and y >= 2 and (board[y-1][x+1] == 'b' or board[y-1][x+1] == 'B') and board[y-2][x+2] == '.':
            ...
            if y == 2:
                ...
                new_board[y-2][x+2] = 'r'
                double_jump = jump(new_board, x+2, y-2, player)
...
# Minimax implementation for the min player
def dfs_min(board, player):
    worst_move = None
